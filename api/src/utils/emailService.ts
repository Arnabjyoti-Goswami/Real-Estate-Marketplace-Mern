...
const getTransporter = async () => {
  try {
    ...
    // I am exporting mailOptions from within this file only as the email needs to be same as the configured email in the transporter, if using gmail provider
